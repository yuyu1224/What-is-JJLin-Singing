  ...
  setup() {
    ...
    function generateSunburst(data) {
      ...
      svg
        .attr(
          "viewBox",
          `${-radius + 220} ${-radius - 20} ${2 * radius - 20} ${
            2 * radius + 40
          }`,
        )
      ...
      svg
        ...
        .on("mouseenter", (event, d) => {
          ...
          label.style("visibility", null).select(".value").text(displayText);
      ...
      const rightTextBoxText = rightTextBoxGroup
        .append("text")
        .attr("x", 10)
        .attr("y", 20)
